...
export default async function AccountsPage() {
  ...
  return (
    <section className="max-w-4xl px-6 py-10">
      <h1 className="text-2xl font-black tracking-tight text-slate-900 dark:text-white">Investments &amp; savings</h1>
      <p className="mt-2 text-sm text-slate-500 dark:text-slate-400">
        Add each asset — an FD, a mutual fund, a bank account — under the
