...
function BridgeMark() {
  return (
    <svg viewBox="0 0 640 180" className="w-full max-w-2xl" aria-hidden="true">
      ...
      <text x="30" y="40" fontFamily="var(--font-source-sans)" fontSize="15" fill="#F2A93B" fontWeight={600}>
        Home
      </text>
      <text x="560" y="40" fontFamily="var(--font-source-sans)" fontSize="15" fill="#0FA968" fontWeight={600}>
        Away
      </text>
    </svg>
  );
    ...
    <main className="min-h-screen bg-paper">
      <header className="border-b border-line">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-5">
          <span className="font-display text-2xl italic text-ink">Smart Money Folio</span>
          <nav className="flex items-center gap-6 text-base">
            <Link href="/login" className="text-ink hover:text-folio focus-ring">
              Log in
            </Link>
            <Link
              href="/signup"
              className="border border-ink px-4 py-2 text-ink hover:border-folio hover:text-folio focus-ring"
            >
              Get started
            </Link>
          </nav>
      ...
      <section className="mx-auto max-w-5xl px-6 pb-10 pt-16">
        <p className="text-base font-semibold uppercase tracking-wide text-folio">
        ...
        <div className="mt-8 flex items-center gap-4">
          ...
          <Link href="/login" className="text-ink underline decoration-line underline-offset-4 hover:text-folio focus-ring">
      ...
      <section className="border-t border-line bg-paper-2">
        <div className="mx-auto grid max-w-5xl gap-10 px-6 py-16 md:grid-cols-3">
          <div>
            <h2 className="font-display text-2xl text-ink">Dual-currency cash flow</h2>
          ...
          <div>
            <h2 className="font-display text-2xl text-ink">Consolidated family wealth</h2>
            <p className="mt-3 text-base leading-relaxed text-ink-2">
          ...
          <div>
            <h2 className="font-display text-2xl text-ink">One household, many members</h2>
            <p className="mt-3 text-base leading-relaxed text-ink-2">
      ...
      <footer className="border-t border-line px-6 py-8 text-center text-sm text-ink-2">
